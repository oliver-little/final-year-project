...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item However, while this means I will not have to consider challenges like restarting failed nodes from a container perspective, there will still be other resilience considerations like ensuring the workflow recalculates any data for failed nodes. % make this clearer (i.e.: recalculating data for failed nodes)
		\end{itemize}
