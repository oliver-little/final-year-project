...
\newcommand\pythonstyle{\lstset{
		...
		breaklines=true,
		morekeywords={self, cassandra_table, evaluate, Pow, ToDouble, Substring, ToString, select, filter, group_by, as_name},              % Add keywords here
		keywordstyle=\color{blue},
		emph={ClusterManager, Max, Avg, Min, F, Function, __init__},          % Custom highlighting
...
\begin{document}
	...
	\appendix
	%\renewcommand{\thechapter}{\Alph{section}.\arabic{section}}
